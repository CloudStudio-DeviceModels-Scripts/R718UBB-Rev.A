...
# Parsing + Configuration Script – R718UBB - Rev. A

This **Parsing + Configuration** script is designed for the **R718UBB** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – R718UBB Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **R718UBB** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
